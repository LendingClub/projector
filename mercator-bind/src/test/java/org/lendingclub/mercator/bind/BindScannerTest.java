...
public class BindScannerTest {
	...
	public void setup() {
		...
		List<String> zones = Arrays.asList("tlcinternal.com");
	...
	public void getRecordTest() {
		...
		String line = "test.tlcinternal.com. 60 IN	A	10.10.10.10";	
		scanner = new BindScanner(null);
		ResourceRecordSet<Map<String, Object>> dnsRecord = scanner.getRecord(line);
		Assert.assertEquals(dnsRecord.getName(), "test.tlcinternal.com");
	}
}
